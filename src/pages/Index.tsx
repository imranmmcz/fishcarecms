...
import { ModernHome } from "@/components/layouts/ModernHome";
import { MegaShopHome } from "@/components/layouts/MegaShopHome";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const ClassicHome = () => {
  ...
  const benefits = [
    { icon: FlaskConical, title: t.scientificMethod, description: t.scientificMethodDesc },
    { icon: Leaf, title: t.resourceOptimization, description: t.resourceOptimizationDesc },
    { icon: BarChart3, title: t.productivityIncrease, description: t.productivityIncreaseDesc },
    { icon: Languages, title: t.easyToUse, description: t.easyToUseDesc },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative"><HeroSlider /></section>
      <FlashSaleSection />
      <FeaturedProducts />
      ...
      <section className="py-10 sm:py-16">
        <div className="container px-3 sm:px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 text-foreground">{t.whyUseSystem}</h2>
      ...
      <section className="py-10 sm:py-16 bg-gradient-primary text-white">
        <div className="container text-center space-y-4 sm:space-y-6 px-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold">{t.startManagement}</h2>
          <p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto">{t.startManagementDesc}</p>
