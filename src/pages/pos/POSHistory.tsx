          ...
          {selectedSale && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div><span className="text-muted-foreground">পেমেন্ট:</span> <Badge variant="outline">{selectedSale.payment_method === "cash" ? "ক্যাশ" : selectedSale.payment_method === "due" ? "বাকি" : "মোবাইল ব্যাংকিং"}</Badge></div>
        ...
        <div ref={printRef}>
          ...
          <table>
            <tbody>
              ...
              <tr><td className="small">প্রদান ({selectedSale?.payment_method === "cash" ? "ক্যাশ" : selectedSale?.payment_method === "due" ? "বাকি" : "মোবাইল"})</td><td className="small right" style={{ textAlign: "right" }}>৳{selectedSale?.paid_amount}</td></tr>
              {selectedSale?.change_amount > 0 && (
